...
export default function NaverSessionPage() {
 ...
 NID_AUT:{' '}
 {preview.nidAut
 ? <span className="text-green-600 font-medium inline-flex items-center gap-0.5"><Check size={12} strokeWidth={3} />확인됨</span>
 : <span className="text-red-500 inline-flex items-center gap-0.5"><X size={12} strokeWidth={3} />없음 (필수)</span>}
 </p>
 <p>
 NID_SES:{' '}
 {preview.nidSes
 ...
 ? <span className="text-green-600 font-medium inline-flex items-center gap-0.5"><Check size={12} strokeWidth={3} />확인됨 · 리뷰 관리 가능</span>
 : <span className="text-red-500 font-medium inline-flex items-center gap-0.5"><X size={12} strokeWidth={3} />없음 · SmartPlace 리뷰 탭에서 다시 복사하세요</span>}
 </p>
